...
- The export key only ever exists inside an attested enclave. No machine the agent can shell into ever holds plaintext. This closes the local deployment's honest-agent gap (see [THREAT-MODEL.md](./THREAD-MODEL.md).
